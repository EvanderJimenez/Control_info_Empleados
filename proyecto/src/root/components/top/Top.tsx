...
export function Top() {
  return (
    <>
      <nav className="print:hidden g-SecondaryColor border-gray-200 dark:bg-black">
        <div className="flex flex-wrap justify-between items-center mx-auto max-w-screen-xl p-4 print:hidden">
          ...
          <div className="flex items-center">
            ...
            <a href="/" className="text-sm  text-blue dark:text-blue-500 hover:underline print:hidden">
              Login
            </a>
          </div>
        </div>
      </nav>
      <nav className="bg-SecondaryColor dark:bg-gray-700 print:hidden">

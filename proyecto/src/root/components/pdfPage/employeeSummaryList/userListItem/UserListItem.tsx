    ...
    <li className="pt-3 pb-0 w-full sm:pt-4">
      <div className="flex w-full items-center ">
        <div className="flex flex-row space-x-2">
          <div><p className="w-8 h-8 rounded-full text-white mr-6 print:text-black">{name}</p></div>
          <div><p className="w-8 h-8 rounded-full text-white  print:text-black">{FirstSurname}</p></div>
        </div>

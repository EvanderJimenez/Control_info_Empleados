      ...
      <form className="flex items-center" onSubmit={handleSubmit}>
        ...
        <div className="relative w-full">
          ...
          <input
            type="text"
            id="voice-search"
            className="bg-gray-50 border border-gray-300 text-black text-sm focus:ring-blue-500 focus:border-blue-500 block w-full pl-10 p-2.5  dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-darkBlue dark:focus:ring-blue-500 dark:focus:border-blue-500"
            placeholder="Search "
          />
          <button
            type="button"

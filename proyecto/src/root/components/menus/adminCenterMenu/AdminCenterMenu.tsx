      ...
      <div className=" print:hidden left-0 z-50 w-full h-20 bg-SecondaryColor  dark:bg-gray-700 dark:border-gray-600">
        <div className="grid h-full max-w-lg grid-cols-4 mx-auto font-medium">
          ...
          >
            ...
            <span className="text-sm text-gray-500 dark:text-gray-400 group-hover:text-blue-600 dark:group-hover:text-blue-500">Control Employees</span>
          </button>
          <button
          ...
          >
            ...
            <span className="text-sm text-gray-500 dark:text-gray-400 group-hover:text-blue-600 dark:group-hover:text-blue-500">Control Departments</span>
          </button>
